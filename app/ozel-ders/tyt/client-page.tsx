...
const tytSubjects = [
  { slug: "turkce", name: "Türkçe", questions: 40, icon: BookOpen, color: "bg-red-500", price: "600" },
  { slug: "matematik", name: "Matematik", questions: 40, icon: Calculator, color: "bg-blue-500", price: "700" },
  { slug: "fen-bilimleri", name: "Fen Bilimleri", questions: 20, icon: FlaskConical, color: "bg-green-500", price: "650" },
  { slug: "sosyal-bilimler", name: "Sosyal Bilimler", questions: 20, icon: Globe, color: "bg-amber-500", price: "550" },
];

const teachers = [
  { name: "Mehmet Özkan", subject: "Matematik", rating: 4.9, students: 200, experience: "12 yıl" },
  { name: "Ayşe Yıldız", subject: "Türkçe", rating: 5.0, students: 180, experience: "15 yıl" },
  { name: "Caner Erkin", subject: "Fen Bilimleri", rating: 4.8, students: 150, experience: "10 yıl" },
];
...
const benefits = [
  ...
  { icon: Target, title: "Hedef Odaklı", desc: "Net hedeflerinize özel program" },
  { icon: TrendingUp, title: "Sürekli İlerleme", desc: "Haftalık takip ve analiz" },
];

const studyPlan = [
  { phase: "Başlangıç", focus: "Konu anlatımı ve temel kavramlar", duration: "1-2 ay" },
  { phase: "Geliştirme", focus: "Soru çözümü ve pekiştirme", duration: "2-3 ay" },
  { phase: "Yoğunlaşma", focus: "Deneme sınavları ve analiz", duration: "1-2 ay" },
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty">
              Uzman TYT koçlarımızla birebir özel ders. Türkçe, Matematik, Fen ve Sosyal dersler için 
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Her ders için uzman öğretmenler ve kişiselleştirilmiş eğitim programı
            </p>
          </motion.div>
              ...
              >
                <Card className="p-6 hover:shadow-lg transition-all group h-full">
                  <div className="flex flex-col">
                    ...
                    <p className="text-muted-foreground text-sm mb-4">{subject.questions} Soru</p>
                    <div className="mt-auto">
                      <div className="flex items-baseline gap-1 mb-4">
                        <span className="text-2xl font-bold text-blue-600">{subject.price}</span>
              ...
              >
                <Card className="p-6 text-center h-full">
                  <div className="w-20 h-20 bg-blue-500/10 rounded-full mx-auto mb-4 flex items-center justify-center">
                    <span className="text-2xl font-bold text-blue-600">{teacher.name.charAt(0)}</span>
                  </div>
                  <h3 className="text-lg font-semibold text-foreground">{teacher.name}</h3>
                  <p className="text-blue-600 text-sm mb-3">{teacher.subject}</p>
                ...
                <Card className="p-6">
                  <div className="flex flex-col md:flex-row md:items-center gap-4">
                    <div className="md:w-32">
                      <span className="font-semibold text-blue-600">{plan.phase}</span>
                    </div>
