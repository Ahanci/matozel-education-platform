        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6 text-balance">
              ...
              <span className="text-primary block mt-2">Geleceğini Şekillendir</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty">
              {gradeData.name} müfredatına %100 uygun, sınav odaklı ve kazanım temelli
              birebir özel ders programları.
            </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">{gradeData.name} Dersleri</h2>
            <p className="text-muted-foreground">İhtiyacın olan tüm derslerde uzman desteği</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {allSubjects.slice(0, 9).map((subject, index) => { // Showing generic subjects, could filter based on grade later
           ...
           <div className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-r from-primary/10 to-accent/10 p-8 md:p-12">
             <div className="flex flex-col md:flex-row items-center justify-between gap-8">
               <div className="flex-1">
                 <h2 className="text-3xl font-bold mb-4">Hedefin Sınavlar mı?</h2>
                 <p className="text-lg text-muted-foreground mb-6">
                   {relevantExams.map(e => e.name).join(" ve ")} sınavlarına şimdiden hazırlık yapmaya başla,
