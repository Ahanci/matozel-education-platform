...
const benefits = [
  ...
  },
  {
    icon: Target,
    title: "Alan Odaklı",
    desc: "Sayısal/Sözel uzmanlaşmış program",
  },
  {
    icon: TrendingUp,
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6 text-balance">
              ...
              <span className="text-purple-600 block mt-2">
                Hayalindeki Bölüme Yerleş
              </span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty">
              Uzman AYT koçlarımızla birebir özel ders. Sayısal ve Sözel alan
              dersleri için alanında uzman öğretmenler.
            </p>
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="mt-auto">
                      ...
                      <Button
                        ...
                        asChild
                      >
                        <Link href={`/ozel-ders/${subject.slug}/ayt`}>
                          Ders Al
                        </Link>
                      </Button>
                    </div>
