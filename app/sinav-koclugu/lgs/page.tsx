...
const lgsSubjects = [
  ...
  { name: "Fen Bilimleri", questions: 20, icon: TrendingUp, color: "bg-green-500" },
  { name: "T.C. İnkılap Tarihi", questions: 10, icon: FileText, color: "bg-amber-500" },
  { name: "Din Kültürü", questions: 10, icon: BookOpen, color: "bg-purple-500" },
...
const studyPlan = [
  { month: "Eylül-Ekim", focus: "Temel kavramlar ve konu taraması", intensity: 60 },
  { month: "Kasım-Aralık", focus: "Konu pekiştirme ve soru tipleri", intensity: 75 },
  { month: "Ocak-Şubat", focus: "Yoğun soru çözümü ve denemeler", intensity: 85 },
  { month: "Mart-Nisan", focus: "Eksik konu tamamlama", intensity: 90 },
  { month: "Mayıs-Haziran", focus: "Son tekrar ve mental hazırlık", intensity: 100 },
];
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6 text-balance">
              ...
              <span className="text-primary block mt-2">Hayalindeki Liseye Ulaş</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty">
              Deneyimli LGS koçlarımız eşliğinde, kişiselleştirilmiş çalışma programı ve 
              birebir takip ile hedefine en kısa yoldan ulaş. Türkiye genelinde aynı gün kaynak temini.
            </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-center md:text-left">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white/80">Türkiye'nin 81 iline aynı gün kargo ile kaynak gönderimi</p>
              </div>
            </div>
            <div className="flex items-center gap-2 text-white/90">
              <MapPin className="w-5 h-5" />
              <span>İstanbul, Ankara, İzmir ve tüm illere ekspres teslimat</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Toplam 90 soru, 120 dakika süre. Her ders için uzman koçlarımızla çalışın.
            </p>
          </motion.div>
                ...
                <Card className="p-6 hover:shadow-lg transition-all group">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-muted-foreground">{subject.questions} Soru</p>
                    </div>
                  </div>
                ...
                <Card className="p-6">
                  <div className="flex flex-col md:flex-row md:items-center gap-4">
                    <div className="md:w-32">
                      <span className="font-semibold text-primary">{plan.month}</span>
                    </div>
                    <div className="flex-1">
                    ...
                    <div className="md:w-48">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-muted-foreground w-12">%{plan.intensity}</span>
                      </div>
                    </div>
                  </div>
                </Card>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {packages.map((pkg, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
              >
                <Card className={`p-8 h-full flex flex-col ${pkg.popular ? "border-primary shadow-lg scale-105" : ""}`}>
                  {pkg.popular && (
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
              Ücretsiz seviye tespit sınavı ve danışmanlık görüşmesi ile hedeflerinizi belirleyelim.
              Türkiye'nin her yerine aynı gün kaynak gönderimi ile hiç zaman kaybetmeyin.
            </p>
